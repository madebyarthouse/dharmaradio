...
const TeacherRSSItemValidator = z.object({
  title: z.string(),
  link: z.string(),
  pubDate: z.string(),
  enclosure: z.object({
...
export const TeacherRSSFeedValidator = z.object({
  items: z.array(TeacherRSSItemValidator),
  feedUrl: z.string(),
...
export type TeacherRSSFeed = z.infer<typeof TeacherRSSFeedValidator>;
